...
git fetch http://gerrit.sudoservers.com/AOKP/frameworks_base refs/changes/17/5117/17 && git cherry-pick FETCH_HEAD
...
git fetch http://gerrit.sudoservers.com/AOKP/packages_apps_ROMControl refs/changes/20/5120/6 && git cherry-pick FETCH_HEAD
cd $root
